 ...
 */
final class Version20210318185846 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, born_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, nic VARCHAR(255) NOT NULL, telephone_number VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE task_order (id INT NOT NULL, rol VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE ticket (id INT NOT NULL, sell_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, price INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE track (id INT NOT NULL, duration_in_minutes INT NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_private BOOLEAN NOT NULL, lenght_in_meters INT NOT NULL, seats INT NOT NULL, modality VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE client ADD lastname VARCHAR(255) DEFAULT NULL');
